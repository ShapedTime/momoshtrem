 ...
 * Used in: SearchBar, search page empty state
 */
 ...
 * Used in: RatingBadge (hero variant)
 */
...
/**
 * Film/movie placeholder icon.
 * Used in: MediaCard when no poster is available
 */
export function FilmIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
/**
 * X/close icon.
 * Used in: SearchBar clear button, modals
 */
 ...
 * Used in: Button loading state, search loading
 */
...
/**
 * Menu/hamburger icon.
 * Used in: Mobile navigation toggle
 */
 ...
 * Used in: FilterSidebar collapse, navigation
 */
